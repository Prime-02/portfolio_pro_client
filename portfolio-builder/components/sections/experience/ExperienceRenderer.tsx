// portfolio-builder/components/sections/experience/ExperienceRenderer.tsx
"use client";
...
export default function ExperienceRenderer({ data, username, animationKey }: ExperienceRendererProps) {
  ...
  const renderLayout = () => {
    switch (layout) {
      ...
      case "timeline-horizontal": return <TimelineHorizontalLayout {...layoutProps} />;
