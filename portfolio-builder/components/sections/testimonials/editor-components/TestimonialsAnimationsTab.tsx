// portfolio-builder/components/sections/testimonials/editor-components/TestimonialsAnimationsTab.tsx
...
interface TestimonialsAnimationsTabProps {
...
export default function TestimonialsAnimationsTab({ data, onUpdate }: TestimonialsAnimationsTabProps) {
      ...
      {isAnimated && (
        <div className={sectionClass}>
          ...
          <Toggle
            ...
            description="Each testimonial card animates in sequence"
