// portfolio-builder/components/sections/experience/editor-components/ExperienceEditorTabs.tsx

interface ExperienceEditorTabsProps {
  activeTab: string;
  onTabChange: (
...
export default function ExperienceEditorTabs({ activeTab, onTabChange }: ExperienceEditorTabsProps) {
  return (
