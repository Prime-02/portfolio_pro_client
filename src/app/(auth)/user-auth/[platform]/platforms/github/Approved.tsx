...
const Approved = () => {
  ...
  const contructedURL = PathUtil.buildUrlWithQuery(
    `${V1_BASE_URL}/github-auth/callback`,
    {
      code: code,
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center p-8 ">
      {loading.includes("github_verification_in_progress") ? (
        <div>
          <div>
            <PortfolioProLogo
              tracking={0.2}
        ...
        <div className="flex flex-col p-2 items-center min-w-sm h-full border border-[var(--accent)]/20 rounded-2xl w-auto">
          <div
            className={`object-cover rounded-full ${!isDarkMode ? "bg-white" : "bg-black"} w-10 h-10 `}
          >
            <Image
