...
import { LanguageProps } from "@/src/app/components/types and interfaces/loaderTypes";
...
export const socialMediaPlatforms = [
  ...
  // Tier 1: Essential Professional & Major Social Networks
  {
    code: "LinkedIn",
    id: "LinkedIn",
    icon: FaLinkedin,
  ...
  // Tier 2: Major Communication Platforms
  {
    code: "WhatsApp",
    id: "WhatsApp",
    icon: FaWhatsapp,
  ...
  // Tier 4: Emerging & Rising Platforms
  {
    code: "Threads",
    id: "Threads",
    icon: FaThreads,
  ...
  // Tier 5: Creative & Design Platforms
  {
    code: "Behance",
    id: "Behance",
    icon: FaBehance,
  ...
  // Tier 6: Content Creator & Monetization Platforms
  {
    code: "Patreon",
    id: "Patreon",
    icon: FaPatreon,
  ...
  // Tier 9: Business & Professional Tools
  {
    code: "Zoom",
    id: "Zoom",
    icon: SiZoom,
  ...
  // Tier 10: Regional & Specialized Networks
  {
    code: "Xiaohongshu",
    id: "Xiaohongshu",
    icon: SiXiaohongshu,
