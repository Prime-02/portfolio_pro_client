// portfolio-builder/components/sections/experience/editor-components/ExperienceAnimationsTab.tsx
...
interface ExperienceAnimationsTabProps {
  data: ExperienceData;
...
export default function ExperienceAnimationsTab({ data, onUpdate }: ExperienceAnimationsTabProps) {
      ...
      {isAnimated && (
        <div className={sectionClass}>
          ...
          <Toggle
            ...
            description="Each experience card animates in sequence"
