// portfolio-builder/components/sections/testimonials/editor-components/TestimonialsCTATab.tsx
...
interface TestimonialsCTATabProps {
...
export default function TestimonialsCTATab({ data, onChange }: TestimonialsCTATabProps) {
  ...
  const addButton = () => {
    const newButton: BioCTA = {
      ...
      url: `/${userInfo?.username || ""}/testimonials`,
      variant: "primary",
      openInNewTab: false,
    };
            ...
            {!isCollapsed && (
              <div className="p-4 space-y-4">
                <Textinput
                  ...
                  placeholder='e.g. "View All Testimonials"'
                />
