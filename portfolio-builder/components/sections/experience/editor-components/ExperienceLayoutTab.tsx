...
const LAYOUT_OPTIONS: {
  ...
  preview: React.ReactNode;
    ...
    },
    {
      ...
      preview: (
        <svg viewBox="0 0 48 32" fill="none" className="w-full h-full">
          <line x1="2" y1="16" x2="46" y2="16" stroke="var(--pb-foreground)" strokeWidth="0.5" strokeOpacity="0.3" />
          <circle cx="10" cy="16" r="2" fill="var(--pb-foreground)" opacity="0.3" />
          <rect x="4" y="4" width="12" height="10" rx="1" fill="var(--pb-foreground)" opacity="0.15" stroke="var(--pb-foreground)" strokeWidth="0.5" strokeOpacity="0.3" />
          <circle cx="24" cy="16" r="2" fill="var(--pb-foreground)" opacity="0.3" />
          <rect x="18" y="18" width="12" height="10" rx="1" fill="var(--pb-foreground)" opacity="0.15" stroke="var(--pb-foreground)" strokeWidth="0.5" strokeOpacity="0.3" />
          <circle cx="38" cy="16" r="2" fill="var(--pb-foreground)" opacity="0.3" />
          <rect x="32" y="4" width="12" height="10" rx="1" fill="var(--pb-foreground)" opacity="0.15" stroke="var(--pb-foreground)" strokeWidth="0.5" strokeOpacity="0.3" />
        </svg>
      ),
    },
    {
