// portfolio-builder/components/sections/skills/editor-components/SkillsEditorActions.tsx

interface SkillsEditorActionsProps {
  hasChanges: boolean;
  isSaving: boolean;
  saveStatus: string;
...
export default function SkillsEditorActions({
  hasChanges,
  saveStatus,
  saveStatusColor,
  onSave,
