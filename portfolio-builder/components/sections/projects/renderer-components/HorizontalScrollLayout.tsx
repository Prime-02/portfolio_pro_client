// portfolio-builder/components/sections/projects/renderer-components/HorizontalScrollLayout.tsx
...
export default function HorizontalScrollLayout({
    ...
    const checkAutoPlayEligibility = useCallback(() => {
        ...
        const eligible = projects.length > MIN_CARDS_FOR_AUTOPLAY && visibleCards < projects.length;
    ...
    // Only duplicate if there are enough projects to warrant it
    const shouldDuplicate = projects.length > MIN_CARDS_FOR_AUTOPLAY;
    const duplicatedProjects = shouldDuplicate ? [...projects, ...projects] : projects;
            ...
            >
                ...
                >
                    {duplicatedProjects.map((project, index) => (
                        <div
                            key={`${project.id || index}-${index < projects.length ? 'first' : 'second'}`}
