// portfolio-builder/components/sections/blogs/editor-components/BlogsEditorTabs.tsx

interface BlogsEditorTabsProps {
  activeTab: string;
  onTabChange: (
...
export default function BlogsEditorTabs({ activeTab, onTabChange }: BlogsEditorTabsProps) {
  return (
