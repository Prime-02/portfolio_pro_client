// portfolio-builder/components/sections/skills/editor-components/SkillsCTATab.tsx
...
export default function SkillsCTATab({ data, onChange }: SkillsCTATabProps) {
