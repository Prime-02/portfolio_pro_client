// portfolio-builder/components/sections/experience/editor-components/ExperienceCTATab.tsx
...
interface ExperienceCTATabProps {
  data: ExperienceData;
...
export default function ExperienceCTATab({ data, onChange }: ExperienceCTATabProps) {
  ...
  const addButton = () => {
    const newButton: BioCTA = {
      ...
      url: `/${userInfo?.username || ""}/experience`,
      variant: "primary",
      openInNewTab: false,
    };
            ...
            {!isCollapsed && (
              <div className="p-4 space-y-4">
                <Textinput
                  ...
                  placeholder='e.g. "View Full Experience"'
                />
