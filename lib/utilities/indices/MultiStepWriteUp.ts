...
export const accountBasics = {
  ...
  fields: [
    ...
    },
    {
      ...
      required: true,
      description:
        "Your first name. This will be displayed on your profile.",
      constraints: {
        max_length: 100,
        min_length: 1,
      },
    },
    {
      ...
      required: true,
      description:
        "Your last name. This will be displayed on your profile.",
      constraints: {
        max_length: 100,
        min_length: 1,
      },
    },
    {
      ...
      required: false,
      description:
        "Your phone number (optional). Include country code (e.g., +1234567890). Must contain only digits, +, -, or spaces.",
      constraints: {
        max_length: 20,
        pattern: "^[\\d\\+\\-\\s]*$",
      },
  ...
  fields: [
    {
      ...
      required: false,
      description:
        "Your profession (e.g., Software Engineer).",
      constraints: {
        max_length: 255,
      },
    },
    {
      ...
      required: false,
      description:
        "Your current or desired job title (e.g., Senior Developer).",
      constraints: {
        max_length: 255,
      },
    },
    ...
    },
    {
      ...
      required: false,
      description:
        "A biography describing your professional background.",
      constraints: {
        max_length: 1000,
      },
    },
    ...
    },
    {
      ...
      required: false,
      description:
        "Your availability (e.g., 'Immediate', '1 month notice', etc.).",
      constraints: {
        max_length: 255,
        enum: [
          {
  ...
  fields: [
    {
      ...
      required: false,
      description:
        "Your personal website URL (e.g., https://example.com). Must start with http:// or https://.",
      constraints: {
        max_length: 255,
        pattern: "^https?://.*",
      },
