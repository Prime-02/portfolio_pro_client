// portfolio-builder/components/sections/certification/renderer-components/CertificateCarouselLayout.tsx
...
export default function CertificateCarouselLayout({
  certifications,
  data,
  isAnimated,
  shouldAnimate,
  ...
  const pageCerts = certifications.slice(currentPage * itemsPerPage, (currentPage + 1) * itemsPerPage);
