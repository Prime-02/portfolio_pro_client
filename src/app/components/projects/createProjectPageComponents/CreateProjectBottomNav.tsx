...
const TAB_ORDER: CreateTab[] = ["basic", "media", "settings"];

const TAB_META: Record<CreateTab, { label: string; icon: typeof FileText }> = {
    basic: { label: "Basic Info", icon: FileText },
    media: { label: "Media", icon: Image },
    settings: { label: "Settings", icon: Settings },
};

interface CreateProjectBottomNavProps {
    activeTab: CreateTab;
    onChange: (tab: CreateTab) => void;
}

export function CreateProjectBottomNav({ activeTab, onChange }: CreateProjectBottomNavProps) {
