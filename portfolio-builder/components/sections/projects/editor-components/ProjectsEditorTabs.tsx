// portfolio-builder/components/sections/projects/editor-components/ProjectsEditorTabs.tsx

interface ProjectsEditorTabsProps {
  activeTab: string;
  onTabChange: (
...
export default function ProjectsEditorTabs({ activeTab, onTabChange }: ProjectsEditorTabsProps) {
  return (
