...
interface CertificationEditorProps {
  ...
  onSave: (data: CertificationData) => Promise<void>;
  onCancel: () => void;
  setFullScreen: (latestData: CertificationData) => void;
  username: string;
}
...
export default function CertificationEditor({
  ...
  const [data, setData] = useState<CertificationData>(() => structuredClone(resolvedInitialData));
  ...
  const pendingSaveRef = useRef<CertificationData | null>(null);
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case "filters":
        return <CertificationFilterTab data={data} onUpdate={updateFilters} />;
      case "card-layout":
        return <CertCardLayoutTab data={data} onChange={updateField} />;
      case "layout":
        return <CertificationLayoutTab data={data} onChange={updateField} />;
      case "background":
        return (
          <CertificationBackgroundTab
            data={data}
      ...
      case "animations":
        return <CertificationAnimationsTab data={data} onUpdate={updateAnimations} />;
      case "cta":
        return <CertificationCTATab data={data} onChange={updateField} />;
      default:
        return null;
    }
  };
