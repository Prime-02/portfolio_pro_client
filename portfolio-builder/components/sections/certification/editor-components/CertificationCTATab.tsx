...
interface CertificationCTATabProps {
...
export default function CertificationCTATab({ data, onChange }: CertificationCTATabProps) {
  ...
  const addButton = () => {
    const newButton: BioCTA = {
      ...
      url: `/${userInfo?.username || ""}/certification`,
      variant: "primary",
      openInNewTab: false,
    };
            ...
            {!isCollapsed && (
              <div className="p-4 space-y-4">
                <Textinput
                  ...
                  placeholder='e.g. "View All Certifications"'
                />
