// portfolio-builder/components/sections/testimonials/editor-components/TestimonialsEditorTabs.tsx

interface TestimonialsEditorTabsProps {
  activeTab: string;
  onTabChange: (
...
export default function TestimonialsEditorTabs({ activeTab, onTabChange }: TestimonialsEditorTabsProps) {
  return (
