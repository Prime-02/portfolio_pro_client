...
import type { EducationData, EducationCardOverride } from "@/portfolio-builder/types/education";
...
export function resolveCardOverride(
  ...
  for (const override of overrides) {
    ...
    if (target.fields_of_study?.includes(edu.field_of_study || "")) matches = true;
    ...
    if (matches) {
      return {
        ...
        showInstitutionLogo: override.showInstitutionLogo ?? defaults.showInstitutionLogo,
        showInstitution: override.showInstitution ?? defaults.showInstitution,
        showDegree: override.showDegree ?? defaults.showDegree,
        showFieldOfStudy: override.showFieldOfStudy ?? defaults.showFieldOfStudy,
        ...
        showCurrentIndicator: override.showCurrentIndicator ?? defaults.showCurrentIndicator,
