...
export const ToastDemo: React.FC = () => {
  ...
  const demoToasts = [
    ...
    {
      label: 'Custom Toast',
      action: () => toast.toast('Custom message with sound!', {
        type: 'default',
  ...
  return (
    <div className="p-8 space-y-4">
      <div className="max-w-2xl">
        ...
        <p className=" mb-6">
          A sophisticated toast notification system with full customization capabilities.
          Features include multiple types, positions, animations, progress bars, actions, and more.
        </p>
        ...
        <div className="mt-8 p-4  rounded-lg">
          ...
          <ul className="text-sm  space-y-1">
            <li>• Multiple toast types (success, error, warning, info, default)</li>
