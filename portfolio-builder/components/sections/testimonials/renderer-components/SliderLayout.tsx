// portfolio-builder/components/sections/testimonials/renderer-components/SliderLayout.tsx
...
export default function SliderLayout({
    ...
    const pageTestimonials = testimonials.slice(currentPage * itemsPerPage, (currentPage + 1) * itemsPerPage);
