// portfolio-builder/components/sections/skills/renderer-components/GridLayout.tsx
...
export default function GridLayout({ skills, data, isAnimated, shouldAnimate, anim }: LayoutProps) {
