...
registerBackground({
    ...
    fields: [
        ...
        { kind: "slider", label: "Auto Rotate", key: "colorBendsAutoRotate", defaultValue: 0, min: 0, max: 10, step: 0.1 },
        { kind: "slider", label: "Scale", key: "colorBendsScale", defaultValue: 1, min: 0.1, max: 5, step: 0.1 },
