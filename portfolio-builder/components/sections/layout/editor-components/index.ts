// portfolio-builder/components/sections/layout/editor-components/index.ts

export { default as NavbarTab } from "./NavbarTab";
export { default as FooterTab } from "./FooterTab";
export { default as PageBackgroundTab } from "./PageBackgroundTab";
