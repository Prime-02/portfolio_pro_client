// portfolio-builder/components/sections/projects/ProjectsRenderer.tsx
"use client";
...
export default function ProjectsRenderer({ data, username, animationKey }: ProjectsRendererProps) {
  ...
  const sectionOverflow = layout === "horizontal-scroll" ? "" : "overflow-hidden";
