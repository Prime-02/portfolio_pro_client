// portfolio-builder/components/sections/skills/renderer-components/CarouselLayout.tsx
...
export default function CarouselLayout({
    ...
    const pageSkills = skills.slice(currentPage * itemsPerPage, (currentPage + 1) * itemsPerPage);
