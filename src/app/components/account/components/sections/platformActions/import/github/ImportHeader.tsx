      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-[var(--foreground)]/60 mt-1">
            Import your GitHub repositories as projects. Select individual repositories or import all at once.
          </p>
        </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <Button
            variant="outline"
            size="sm"
            onClick={() => onImportSelected(installationId)}
          ...
          <Button
            variant="default"
            size="sm"
            onClick={() => onImportAll(installationId)}
            disabled={totalRepos === 0 || isImporting || isLoading}
            isLoading={isImporting && !hasSelection}
          >
            <svg
              className="h-4 w-4"
