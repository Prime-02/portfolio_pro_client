...
interface CertificationAnimationsTabProps {
...
export default function CertificationAnimationsTab({ data, onUpdate }: CertificationAnimationsTabProps) {
      ...
      {isAnimated && (
        <div className={sectionClass}>
          ...
          <Toggle
            ...
            description="Each certification card animates in sequence"
