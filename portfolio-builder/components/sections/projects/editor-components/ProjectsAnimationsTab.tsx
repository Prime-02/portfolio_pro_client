// portfolio-builder/components/sections/projects/editor-components/ProjectsAnimationsTab.tsx
...
interface ProjectsAnimationsTabProps {
  data: ProjectsData;
...
export default function ProjectsAnimationsTab({ data, onUpdate }: ProjectsAnimationsTabProps) {
      ...
      {isAnimated && (
        <div className={sectionClass}>
          ...
          <Toggle
            ...
            description="Each project card animates in sequence"
