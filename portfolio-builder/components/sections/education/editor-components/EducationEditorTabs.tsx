// portfolio-builder/components/sections/education/editor-components/EducationEditorTabs.tsx

interface EducationEditorTabsProps {
  activeTab: string;
  onTabChange: (
...
export default function EducationEditorTabs({ activeTab, onTabChange }: EducationEditorTabsProps) {
  return (
