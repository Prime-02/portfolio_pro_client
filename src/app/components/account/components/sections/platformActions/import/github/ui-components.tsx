...
// These are lightweight, composable components without external dependencies
...
export const CardTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3
      ref={ref as any}
      className={cn("font-league-600 text-lg leading-none tracking-tight", className)}
      {...props}
    />
  )
);
...
export const CardDescription = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => (
    <p
      ref={ref}
      className={cn("text-sm text-[var(--foreground)]/60", className)}
      {...props}
    />
  )
);
...
export const Separator = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn("shrink-0 bg-[var(--foreground)]/10 h-[1px] w-full", className)}
      {...props}
    />
  )
);
...
export const Skeleton = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn("animate-pulse rounded-md bg-[var(--foreground)]/10", className)}
      {...props}
    />
  )
);
...
export const AlertTitle = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h5
      ref={ref}
      className={cn("font-league-600 mb-1 leading-none tracking-tight", className)}
      {...props}
    />
  )
);
...
export const Dialog: React.FC<DialogProps> = ({ open, onOpenChange, children }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      />
      <div className="relative z-50 w-full max-w-lg rounded-xl border border-[var(--foreground)]/10 bg-[var(--background)] p-6 shadow-lg animate-in fade-in zoom-in-95 duration-200">
        {children}
      </div>
    </div>
  );
...
export const DialogTitle: React.FC<React.HTMLAttributes<HTMLHeadingElement>> = ({ className, ...props }) => (
  <h2 className={cn("font-league-600 text-lg leading-none tracking-tight", className)} {...props} />
);

export const DialogDescription: React.FC<React.HTMLAttributes<HTMLParagraphElement>> = ({ className, ...props }) => (
  <p className={cn("text-sm text-[var(--foreground)]/60", className)} {...props} />
);
