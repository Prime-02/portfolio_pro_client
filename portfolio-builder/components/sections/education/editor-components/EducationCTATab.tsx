// portfolio-builder/components/sections/education/editor-components/EducationCTATab.tsx
...
interface EducationCTATabProps {
  data: EducationData;
...
export default function EducationCTATab({ data, onChange }: EducationCTATabProps) {
  ...
  const addButton = () => {
    const newButton: BioCTA = {
      label: "View Full Education",
      url: `/${userInfo?.username || ""}/education`,
      variant: "primary",
      openInNewTab: false,
    };
            ...
            {!isCollapsed && (
              <div className="p-4 space-y-4">
                <Textinput
                  ...
                  placeholder='e.g. "View Full Education"'
                />
