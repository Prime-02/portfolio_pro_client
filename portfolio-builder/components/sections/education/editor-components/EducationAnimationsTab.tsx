// portfolio-builder/components/sections/education/editor-components/EducationAnimationsTab.tsx
...
interface EducationAnimationsTabProps {
  data: EducationData;
...
export default function EducationAnimationsTab({ data, onUpdate }: EducationAnimationsTabProps) {
      ...
      {isAnimated && (
        <div className={sectionClass}>
          ...
          <Toggle
            ...
            description="Each education card animates in sequence"
