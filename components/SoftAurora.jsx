...
export default function SoftAurora({
  ...
  // Refs so the effect never needs to re-run when props change
  ...
  useEffect(() => {
    ...
    function update(time) {
      ...
      program.uniforms.uColor1.value = hexToVec3(color1Ref.current);
      program.uniforms.uColor2.value = hexToVec3(color2Ref.current);
      ...
      program.uniforms.uEnableMouse.value = enableMouseInteractionRef.current;
