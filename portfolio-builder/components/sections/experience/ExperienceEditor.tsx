...
interface ExperienceEditorProps {
  ...
  onCancel: () => void;
  setFullScreen: (latestData: ExperienceData) => void;
  username: string;
}
...
export default function ExperienceEditor({
  ...
  const [data, setData] = useState<ExperienceData>(() => structuredClone(resolvedInitialData));
  ...
  const pendingSaveRef = useRef<ExperienceData | null>(null);
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case "filters":
        return <ExperienceFilterTab data={data} onUpdate={updateFilters} />;
      case "card-layout":
        return <CardLayoutTab data={data} onChange={updateField} />;
      case "layout":
        return <ExperienceLayoutTab data={data} onChange={updateField} />;
      case "background":
        return (
          <ExperienceBackgroundTab
            data={data}
      ...
      case "animations":
        return <ExperienceAnimationsTab data={data} onUpdate={updateAnimations} />;
      case "cta":
        return <ExperienceCTATab data={data} onChange={updateField} />;
      default:
        return null;
    }
  };
