// portfolio-builder/components/sections/blogs/editor-components/BlogsEditorActions.tsx

interface BlogsEditorActionsProps {
  hasChanges: boolean;
  isSaving: boolean;
  saveStatus: string;
...
export default function BlogsEditorActions({
  hasChanges,
  saveStatus,
  saveStatusColor,
  onSave,
