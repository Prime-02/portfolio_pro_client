...
export function LoadingSkeletonBlogs() {
  return (
    <div className="min-h-screen p-6 md:p-8 lg:p-10 max-w-7xl mx-auto">
      ...
      <div className="flex gap-3 mb-8">
        ...
        <div className="h-10 w-36 rounded-xl bg-[var(--foreground)]/5 animate-pulse" />
        <div className="h-10 w-32 rounded-xl bg-[var(--foreground)]/5 animate-pulse" />
        <div className="h-10 w-10 rounded-xl bg-[var(--foreground)]/5 animate-pulse" />
      </div>

      {/* Bento grid skeleton */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {/* Featured large card */}
        <div className="md:col-span-2 lg:col-span-2 h-96 rounded-2xl bg-[var(--foreground)]/5 animate-pulse" />
        {/* Regular cards */}
        {[1, 2, 3, 4, 5].map((i) => (
          <div
            key={i}
            className="h-80 rounded-2xl bg-[var(--foreground)]/5 animate-pulse"
          />
        ))}
      </div>
    </div>
